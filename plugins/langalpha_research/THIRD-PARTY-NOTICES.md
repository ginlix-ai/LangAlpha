...
- `plugins/langalpha_research/skills/dcf-model/TROUBLESHOOTING.md`
...
- `plugins/langalpha_research/skills/check-deck/references/report-format.md`
- `plugins/langalpha_research/skills/check-deck/references/ib-terminology.md`
- `plugins/langalpha_research/skills/check-deck/scripts/extract_numbers.py`
...
- `plugins/langalpha_research/skills/3-statements/references/formatting.md`
- `plugins/langalpha_research/skills/3-statements/references/formulas.md`
- `plugins/langalpha_research/skills/3-statements/references/sec-filings.md`
- `plugins/langalpha_research/skills/earnings-analysis/SKILL.md`
- `plugins/langalpha_research/skills/earnings-analysis/references/best-practices.md`
- `plugins/langalpha_research/skills/earnings-analysis/references/report-structure.md`
- `plugins/langalpha_research/skills/earnings-analysis/references/workflow.md`
